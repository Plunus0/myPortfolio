...
<body>
	...
	<div class="container">
		...
		<ul>
			...
			<li class="sidemenuname"><a href="case_recom_spot.jsp"><h2>가볼만한곳</h2></a></li>
			<li class="sidemenuname"><a href="#"><h2><font color="white">추천맛집</font></h2></a></li>
		</ul>
		</nav>
		...
		<section class="content">
			<h1>추천맛집</h1>
			<hr>
			<iframe src="recom_restaurant.jsp" width="100%" height="90%"></iframe>
		</section>
	</div>
