...
<body>
	...
	<div class="container">
		...
		<nav class="sidemenu">
		<h1 id="sidemenuname">소개</h1>
		<hr>
		<ul>
			<li class="sidemenuname"><a href="case_intro_view.jsp"><h2>전경</h2></a></li>
			<li class="sidemenuname"><a href="#"><h2><font color="white">오시는길</font></h2></a></li>
		</ul>
		</nav>
		...
		<section class="content">
			<h1>오시는길</h1>
			<hr>
			<iframe src="intro_directions.jsp" width="100%" height="90%"></iframe>
		</section>
	</div>
