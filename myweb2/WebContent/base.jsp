...
<body>
	<header>
		...
		<div>
			<a href="javascript:alert('URL이 복사되었습니다.')"><img id="url" src="images/URL 사각.png" alt="URL share"></a>
	...
	<div class="container">
		...
		<nav class="sidemenu">
		<h1 id="sidemenuname">네비</h1>
		<hr>
		<ul>
			<li class="sidemenuname"><a href="#"><h2>메뉴1</h2></a></li>
			<li class="sidemenuname"><a href="#"><h2>메뉴2</h2></a></li>
		</ul>
		</nav>
		...
		<section class="content">
			<h1>전경</h1>
			<hr>
			<iframe src="intro_view.jsp" width="100%" height="90%"></iframe>
		</section>
	</div>
	...
	<h7>
		<span>
			<a href="mian.jsp">이용약관</a>
		</span>|
		<span>
			<a href="mian.jsp">저작권</a>
		</span>|
		<span>
			<a href="mian.jsp">개인정보처리방침</a>
		</span>|
		<span>
			<a href="mian.jsp"><font color="red">Admin</font></a>
		</span>
		<br>
		ALL RIGHT RESERVED.
	</h7> 
