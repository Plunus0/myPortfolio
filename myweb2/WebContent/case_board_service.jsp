...
<body>
	...
	<div class="container">
		...
		<nav class="sidemenu">
		<h1 id="sidemenuname">게시판</h1>
		<hr>
		<ul>
			<li class="sidemenuname"><a href="case_board_notice.jsp"><h2>공지사항</h2></a></li>
			<li class="sidemenuname"><a href="#"><h2><font color="white">고객센터</font></h2></a></li>
		</ul>
		</nav>
		...
		<section class="content">
			<h1>고객센터</h1>
			<hr>
			<iframe src="board_service_01.jsp" width="100%" height="90%"></iframe>
		</section>
	</div>
