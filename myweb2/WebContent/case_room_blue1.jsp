...
<body>
	...
	<div class="container">
		...
		<ul>
			...
			<li class="sidemenuname"><a href="case_room_ocean2.jsp"><h2>오션 2호실</h2></a></li>
			<li class="sidemenuname"><a href="#"><h2><font color="white">블루 1호실</font></h2></a></li>
		</ul>
		</nav>
		...
		<section class="content">
			<h1>블루 1호실</h1>
			<hr>
			<iframe src="room_blue1.jsp" width="100%" height="90%"></iframe>
		</section>
	</div>
