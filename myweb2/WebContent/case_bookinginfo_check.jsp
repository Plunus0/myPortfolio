...
<body>
	...
	<div class="container">
		...
		<hr>
		<ul>
			<li class="sidemenuname"><a href="case_bookinginfo_booking.jsp"><h2>예약하기</h2></a></li>
			<li class="sidemenuname"><a href="case_bookinginfo_status.jsp"><h2>예약현황</h2></a></li>
			<li class="sidemenuname"><a href="#"><h2><font color="white">예약확인/취소</font></h2></a></li>
		</ul>
		</nav>
		...
		<section class="content">
			<h1>예약확인/취소</h1>
			<hr>
			<iframe src="bookinginfo_check.jsp" width="100%" height="90%"></iframe>
		</section>
	</div>
