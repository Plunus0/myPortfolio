...
<body>
	...
	<div class="container">
		...
		<nav class="sidemenu">
		<h1 id="sidemenuname">추천여행지</h1>
		<hr>
		<ul>
			<li class="sidemenuname"><a href="case_recom_festival.jsp"><h2>축제정보</h2></a></li>
			<li class="sidemenuname"><a href="#"><h2><font color="white">가볼만한곳</font></h2></a></li>
			<li class="sidemenuname"><a href="case_recom_restaurant.jsp"><h2>추천맛집</h2></a></li>
		</ul>
		</nav>
		...
		<section class="content">
			<h1>가볼만한곳</h1>
			<hr>
			<iframe src="recom_spot.jsp" width="100%" height="90%"></iframe>
		</section>
	</div>
