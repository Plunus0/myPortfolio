...
<body>
	...
	<div class="container">
		...
		<nav class="sidemenu">
		<h1 id="sidemenuname">객실안내</h1>
		<hr>
		<ul>
			<li class="sidemenuname"><a href="case_room_layout.jsp"><h2>객실 배치도</h2></a></li>
			<li class="sidemenuname"><a href="case_room_ocean1.jsp"><h2>오션 1호실</h2></a></li>
			<li class="sidemenuname"><a href="#"><h2><font color="white">오션 2호실</font></h2></a></li>
			<li class="sidemenuname"><a href="case_room_blue1.jsp"><h2>블루 1호실</h2></a></li>
		</ul>
		</nav>
		...
		<section class="content">
			<h1>오션 2호실</h1>
			<hr>
			<iframe src="room_ocean2.jsp" width="100%" height="90%"></iframe>
		</section>
	</div>
