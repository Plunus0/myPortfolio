...
<body>
	...
	<div class="container">
		...
		<hr>
		<ul>
			<li class="sidemenuname"><a href="#"><h2><font color="white">수영장</font></h2></a></li>
			<li class="sidemenuname"><a href="case_facility_bbq.jsp"><h2>바베큐장</h2></a></li>
			<li class="sidemenuname"><a href="case_facility_gallery.jsp"><h2>갤러리</h2></a></li>
		</ul>
		</nav>
		...
		<section class="content">
			<h1>수영장</h1>
			<hr>
			<iframe src="facility_pool.jsp" width="100%" height="90%"></iframe>
		</section>
	</div>
