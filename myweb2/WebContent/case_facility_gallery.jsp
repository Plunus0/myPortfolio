...
<body>
	...
	<div class="container">
		...
		<nav class="sidemenu">
		<h1 id="sidemenuname">이용시설</h1>
		<hr>
		<ul>
			<li class="sidemenuname"><a href="case_facility_pool.jsp"><h2>수영장</h2></a></li>
			<li class="sidemenuname"><a href="case_facility_bbq.jsp"><h2>바베큐장</h2></a></li>
			<li class="sidemenuname"><a href="#"><h2><font color="white">갤러리</font></h2></a></li>
		</ul>
		</nav>
		...
		<section class="content">
			<h1>갤러리</h1>
			<hr>
			<iframe src="facility_gallery.jsp" width="100%" height="90%"></iframe>
		</section>
	</div>
