...
<body>
	...
	<div class="container">
		...
		<hr>
		<ul>
			<li class="sidemenuname"><a href="#"><h2><font color="white">공지사항</font></h2></a></li>
			<li class="sidemenuname"><a href="case_board_service.jsp"><h2>고객센터</h2></a></li>
		</ul>
		</nav>
		...
		<section class="content">
			<h1>공지사항</h1>
			<hr>
			<iframe src="board_notice_01.jsp" width="100%" height="90%"></iframe>
		</section>
	</div>
